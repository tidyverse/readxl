...
[`readxl::read_excel()`](https://readxl.tidyverse.org/reference/read_excel.md)
...
- **Bounded**: The `skip` and `n_max` arguments constrain
  [`read_excel()`](https://readxl.tidyverse.org/reference/read_excel.md)’s
...
[`anchored()`](https://readxl.tidyverse.org/reference/cell-specification.md)
and
[`cell_limits()`](https://readxl.tidyverse.org/reference/cell-specification.md)
