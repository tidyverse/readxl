...
If you use other packages in the [tidyverse](https://www.tidyverse.org/), you are probably familiar with [readr](https://readr.tidyverse.org/), which reads data from flat files. Like readxl, readr also provides column type guessing, but readr and readxl are very different under the hood.
