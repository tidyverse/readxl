...
// Read.cpp
cpp11::strings read_this_xls_(std::string path, int sheet_i, cpp11::integers limits, bool shim, cpp11::sexp col_names, std::vector<std::string> na, bool trim_ws, bool progress);
extern "C" SEXP _readxl_read_this_xls_(SEXP path, SEXP sheet_i, SEXP limits, SEXP shim, SEXP col_names, SEXP na, SEXP trim_ws, SEXP progress) {
  BEGIN_CPP11
...
// Read.cpp
cpp11::strings read_this_xlsx_(std::string path, int sheet_i, cpp11::integers limits, bool shim, cpp11::sexp col_names, std::vector<std::string> na, bool trim_ws, bool progress);
extern "C" SEXP _readxl_read_this_xlsx_(SEXP path, SEXP sheet_i, SEXP limits, SEXP shim, SEXP col_names, SEXP na, SEXP trim_ws, SEXP progress) {
  BEGIN_CPP11
...
// XlsxWorkSheet.cpp
cpp11::list read_xlsx_(std::string path, int sheet_i, cpp11::integers limits, bool shim, cpp11::sexp col_names, cpp11::strings col_types, std::vector<std::string> na, bool trim_ws, int guess_max, bool progress);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_readxl_read_this_xls_",    (DL_FUNC) &_readxl_read_this_xls_,     8},
    {"_readxl_read_this_xlsx_",   (DL_FUNC) &_readxl_read_this_xlsx_,    8},
