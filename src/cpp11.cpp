...
// XlsWorkSheet.cpp
cpp11::list read_xls_(std::string path, int sheet_i, cpp11::writable::doubles limits, bool shim, cpp11::sexp col_names, cpp11::sexp col_types, std::vector<std::string> na, bool trim_ws, int guess_max, bool progress);
...
// XlsxWorkSheet.cpp
cpp11::list read_xlsx_(std::string path, int sheet_i, cpp11::writable::doubles limits, bool shim, cpp11::sexp col_names, cpp11::sexp col_types, std::vector<std::string> na, bool trim_ws, int guess_max, bool progress);
