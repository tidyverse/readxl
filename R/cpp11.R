...
read_this_xls_ <- function(path, sheet_i) {
  invisible(.Call(`_readxl_read_this_xls_`, path, sheet_i))
}

read_this_xlsx_ <- function(path, sheet_i) {
  invisible(.Call(`_readxl_read_this_xlsx_`, path, sheet_i))
}
