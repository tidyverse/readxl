...
xlsx_is_encrypted_ <- function(path) {
  .Call(`_readxl_xlsx_is_encrypted_`, path)
}

xlsx_decrypt_ <- function(path, password, out_path) {
  .Call(`_readxl_xlsx_decrypt_`, path, password, out_path)
}
