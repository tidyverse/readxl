...
read_this_xls_ <- function(path, sheet_i, limits, shim, progress) {
  invisible(.Call(`_readxl_read_this_xls_`, path, sheet_i, limits, shim, progress))
}

read_this_xlsx_ <- function(path, sheet_i, limits, shim, progress) {
  invisible(.Call(`_readxl_read_this_xlsx_`, path, sheet_i, limits, shim, progress))
}
