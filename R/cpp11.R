...
read_this_xls_ <- function(path, sheet_i, limits, shim, na, trim_ws, progress) {
  .Call(`_readxl_read_this_xls_`, path, sheet_i, limits, shim, na, trim_ws, progress)
}

read_this_xlsx_ <- function(path, sheet_i, limits, shim, na, trim_ws, progress) {
  .Call(`_readxl_read_this_xlsx_`, path, sheet_i, limits, shim, na, trim_ws, progress)
}
